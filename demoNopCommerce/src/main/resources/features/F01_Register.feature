...
Feature: F01_Register  users could register with new accounts
  ...
  Scenario: guest user could register with valid data successfully
    ...
    And user entering "mai" firstName
    And user entering "rostom" lastName
    And user selecting day of birth 14
    And user selecting month 12
    And user selecting year 1991
    And user entering "mai.rostom2@gmail.com" his email
